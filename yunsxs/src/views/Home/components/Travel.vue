  ...
  <div class="travel_bd">
    <div class="travel_mes">
      ...
      <div class="travel_text">
        ...
        <a
          href="#"
        >历史悠久的修水，山川深重，钟秀居多，古老建筑星罗棋布，民俗文化博大精深。这里，有五千年的山背文化，有商代的古艾文明，有始自东汉的军事文化、东晋的道教文化、唐代的佛教文化，有源远流长的姓氏文化、客家文化。</a>
      </div>
    </div>
    <div class="travel_mes">
      <div class="travel_person">
      ...
      <div class="travel_text">
        ...
        <a
          href="#"
        >传承：陈氏故居：修水桃里是清末两代名人陈宝箴、陈三立父子的诞生。还有修水杭猪、修水宁红茶、修水赭砚、西港化红、修水青钱降糖神茶、黄坳西瓜、淮山板鸭、古市花椒等小吃。</a>
      </div>
    ...
    <div class="travel_mes">
      ...
      <div class="travel_text">
        ...
        <a
          href="#"
        >渣津镇，商周时期开始建城，古称艾侯国，是古艾文化策源地 、佛教文化发祥地、中共苏区根据地。渣津是宗教圣地。早在晋代有吴猛和许逊，炼丹于黄龙山及龙安山， 为民除害，追赶孽龙，留有许多故事传说。</a>
      </div>
    </div>
  </div>
</template>
